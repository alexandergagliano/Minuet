...
def main():
    ...
    params["augmentations"] = "grrgccrr" #gn
    params["val_augmentations"] = "grrgccrr" #gn
    ...
    # Logging
    params["logfile_name"] = f"maskdaep_2M_train_lr{params['learning_rate']:.2e}_{prefix}.log"
    ...
    if params["ckpt_path"] is not None:
        daep = LitMaskeddaep(params=params)
